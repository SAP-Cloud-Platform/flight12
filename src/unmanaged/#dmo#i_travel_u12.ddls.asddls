@AbapCatalog.sqlViewName: '/DMO/ITRAV_U12'
...
define root view /DMO/I_Travel_U12
  as select from /dmo/travel12 as Travel -- the travel table is the data source for this view

  composition [0..*] of /DMO/I_Booking_U12 as _Booking

  association [0..1] to /DMO/I_Agency12       as _Agency    on $projection.AgencyID        = _Agency.AgencyID
  association [0..1] to /DMO/I_Customer12     as _Customer  on $projection.CustomerID      = _Customer.CustomerID
...

{
    ...
    @Consumption.valueHelpDefinition: [{ entity : {name: '/DMO/I_Agency12', element: 'AgencyID'  } }]
