@AbapCatalog.sqlViewName: '/DMO/IBOOKSU_U12'
...
define view /DMO/I_BookingSupplement_U12
  as select from /dmo/book_sup_12 as BookingSupplement

  association        to parent /DMO/I_Booking_U12  as _Booking         on  $projection.TravelID  = _Booking.TravelID
                                                                     and $projection.BookingID = _Booking.BookingID

  association [1..1] to /DMO/I_Supplement12     as _Product  on $projection.SupplementID = _Product.SupplementID
  association [1..*] to /DMO/I_Supplement12Text12 as _SupplementText on  $projection.SupplementID = _SupplementText.SupplementID
{
  ...
  key BookingSupplement.booking_supplement_id  as BookingSupplementID,
      ...
      @Consumption.valueHelpDefinition: [{entity: {name: '/DMO/I_SUPPLEMENT12', element: 'SupplementID' },
