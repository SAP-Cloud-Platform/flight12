CLASS /dmo/cx_flight_legacy12 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_12',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_12',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id12 OPTIONAL
        booking_id            TYPE /dmo/booking_id12 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id12 OPTIONAL
        agency_id             TYPE /dmo/agency_id12 OPTIONAL
        customer_id           TYPE /dmo/customer_id12 OPTIONAL
        carrier_id            TYPE /dmo/carrier12-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_12-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_12-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date12 OPTIONAL
        end_date              TYPE /dmo/end_date12 OPTIONAL
        booking_date          TYPE /dmo/booking_date12 OPTIONAL
        flight_date           TYPE /dmo/flight_date12 OPTIONAL
        status                TYPE /dmo/travel_status12 OPTIONAL
        currency_code         TYPE /dmo/currency_code12 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id12,
          mv_booking_id            TYPE /dmo/booking_id12,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id12,
          mv_agency_id             TYPE /dmo/agency_id12,
          mv_customer_id           TYPE /dmo/customer_id12,
          mv_carrier_id            TYPE /dmo/carrier12-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_12-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_12-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date12,
          mv_end_date              TYPE /dmo/end_date12,
          mv_booking_date          TYPE /dmo/booking_date12,
          mv_flight_date           TYPE /dmo/flight_date12,
          mv_status                TYPE /dmo/travel_status12,
          mv_currency_code         TYPE /dmo/currency_code12,
...
CLASS /dmo/cx_flight_legacy12 IMPLEMENTATION.
